            ...
            <div className="p-6 text-gray-900 dark:text-gray-100">
              <div className="overflow-auto">
                <table className='w-full text-sm text-left rtl:text-right text-gray-600 dark:text-gray-400'>
                  ...
                  <tbody>
                    {tasks.data.map((task) => (
                      <tr className='bg-white border-b hover:bg-gray-300 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700' key={task.id}>
                        <td className='px-3 py-2'>{task.id}</td>
                        <td className='px-3 py-2'>
                          <img className='w-[120px]' src={task.image_path} alt="" />
                        </td>
              ...
              <div className='flex flex-row'>
                <Pagination params={tasks} queryParams={queryParams} />
              </div>
            </div>
          </div>
        </div>
